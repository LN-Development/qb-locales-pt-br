local Translations = {
    error = {
        ...
        not_driver = "Você não é o motorista do veículos",
        vehicle_driving_fast = "Este veículo está indo muito rápido",
        seat_occupied = "Este assento está ocupado",
        race_harness_on = "Você está usando um cinto de corrida, você não pode trocar",
        ...
        someone_in_trunk = "Já tem alguém no porta-malas"
    },
    progress = {
    ...
    info = {
        ...
        wrong_ped = "Este modelo de pedestre não permite essa opção",
        nothing_to_remove = "Você não tem nada para remover",
        already_wearing = "Você já está usando isso",
        switched_seats = "Agora você está no assento %{seat}"
    },
    general = {
    ...
    options = {
        ...
        driver_seat = "Botão de Emergência",
