local Translations = {
    ...
    info = {
        ...
        ["not_enough"] = "Você não tem dinheiro suficiente para o depósito. O custo do depósito é de R$%{value}",
        ["deposit_paid"] = "Você pagou R$%{value} de depósito!",
        ...
        ["payout_deposit"] = "(+ R$%{value} de depósito)",
