local Translations = {
    ...
    success = {
        deposit = 'Você pagou um depósito de R$%{deposit}!',
        deposit_returned = 'Seu depósito de R$%{deposit} foi devolvido!',
        sold_hotdogs = '%{value} x Hotdog(\'s) vendido por R$%{value2}',
    ...
    info = {
        ...
        selling_prep = '[~g~E~s~] Preparar Hotdog [Sale: ~g~Ativada~w~]',
        not_selling = '[~g~E~s~] Preparar Hotdog [Sale: ~r~Desativada~w~]',
